...
let db = {};
db.persons = new DB(basePath + '/db/person.db')

db.payment = new DB(basePath + '/db/payment.db')

db.canceled = new DB(basePath + '/db/canceled.db')

db.logs = new DB(basePath + '/db/logger.db')
